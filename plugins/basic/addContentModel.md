...
参考 [IService](sdk/IService.md)、[TableColumn](sdk/TableColumn.md)、[DataType](sdk/DataType.md)。
...
需要说明的是，在内容模型字段中必须包含InputStyle属性，用于设置此字段在内容编辑页面中的提交方式，请参考[InputStyle](sdk/InputStyle.md)。