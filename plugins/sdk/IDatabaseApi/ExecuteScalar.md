...
```csharp
public object ExecuteScalar(IDbConnection connection, string sqlString)
```
...
```csharp
public object ExecuteScalar(IDbTransaction transaction, string sqlString)
```
...
```csharp
public object ExecuteScalar(string connectionString, string sqlString)
```
