...
操作 | 请求 | 地址 | 说明
------ | ------ | ------ | ------
[stl/a 获取链接](stl/a.md) | GET | v1/stl/a | 获取链接
[stl/channel 获取栏目值](stl/channel.md) | GET | v1/stl/channel | 获取栏目值
[stl/channels 获取栏目列表](stl/channels.md) | GET | v1/stl/channels | 获取栏目列表
[stl/content 获取内容值](stl/content.md) | GET | v1/stl/content | 获取内容值
[stl/contents 获取内容列表](stl/contents.md) | GET | v1/stl/contents | 获取内容列表
[stl/site 获取站点值](stl/site.md) | GET | v1/stl/site | 获取站点值
[stl/sites 获取站点列表](stl/sites.md) | GET | v1/stl/sites | 获取站点列表
[stl/sqlContent 获取数据库值](stl/sqlContent.md) | GET | v1/stl/sqlContent | 获取数据库值
[stl/sqlContents 获取数据库列表](stl/sqlContents.md) | GET | v1/stl/sqlContents | 获取数据库列表
...
ChannelTemplateId | Integer | | 栏目模板Id
